...
--SELECT *
  --FROM [PortfolioProjrct].[dbo].[CovidVaccine]

--SELECT *
  --FROM [PortfolioProjrct].[dbo].[CovidDeath]
...
--Showing what Percentage of Poplulatiom got Covid
...
From [PortfolioProjrct].[dbo].[CovidDeath] dea
Join [PortfolioProjrct].[dbo].[CovidVaccine] vac
...
Select *
From PercentPopulationVaccinatedA
